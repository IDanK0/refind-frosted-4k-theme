...
A theme for [rEFInd](https://www.rodsbooks.com/refind/) that runs at 3840×2160.
Frosted-glass tiles, labels, icons and font are all generated by a script from a
single background photograph, so the whole look can be rebuilt around any photo
you like.
